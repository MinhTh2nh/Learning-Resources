...
SELECT P.pnumber, P.dnum , D.mgr_ssn ,E.Lname ,E.Address ,E.bdate
FROM DEPARTMENT D 
...
SELECT DISTINCT p.pnumber  , E.lname
FROM project P
INNER JOIN works_on ON P.pnumber = works_on.pno
INNER JOIN employee E ON works_on.essn = E.ssn
